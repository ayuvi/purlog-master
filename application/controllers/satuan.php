...
class satuan extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('login')) {
            ...
            $menu_kd_menu_details = "S07";  //custom by database
    ...
    public function ax_data_satuan()
    {
        if ($this->session->userdata('login')) {
            ...
            $data = $this->model_satuan->getAllsatuan($length, $start, $cari['value'])->result_array();
            $count = $this->model_satuan->get_count_satuan($cari['value']);
    ...
    public function ax_get_data_by_id()
    {
        if ($this->session->userdata('login')) {
            ...
            if(empty($id_satuan))
                ...
                $data = $this->model_satuan->get_satuan_by_id($id_satuan);
