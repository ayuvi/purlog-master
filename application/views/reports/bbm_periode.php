...
<body class="sidebar-mini wysihtml5-supported <?= $this->config->item('color')?>">
								...
								<form id="form" class="form-horizontal">
									...
									<div class="form-body">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input name="tahun" id="tahun" placeholder="Tahun" class="form-control" type="text">
								...
								<div class="form-body">
									<center>
										<div class="form-group">
											...
											<div class="col-md-3">
												<button type="button" class="btn btn-success" onclick="printCetakKredit()"><i class="fa fa-print"></i> Cetak Kredit</button>
								...
								<div class="form-body">
									<center>
										<div class="form-group">
											...
											<div class="col-md-3">
												<button type="button" class="btn btn-success" onclick="printCetakKredit2()"><i class="fa fa-print"></i> Cetak Kredit</button>
	...
	<script type="text/javascript">
		...
		function printCetakKredit() {
			if ($('#tahun').val()!='' && $('#bulan').val()!='0' && $('#supplier').val()!='0' && $('#tanggal_cetak').val()!='') {
				var url     = "<?= base_url() ?>reports/satu1/	";
				var tahun 			= $('#tahun').val();
				var bulan 			= $('#bulan').val();
				var supplier 		= $('#supplier').val();
				var tanggal_cetak 	= $('#tanggal_cetak').val();
