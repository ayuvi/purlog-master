    <header class="main-header">
        <a href="<?= base_url()?>" class="logo">
          ...
          <span class="logo-lg"><img width="30" height="" src="<?= base_url()?>assets/img/survei.png"  alt="Enterprise"/> <strong>PURLOG</strong></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
			  ...
			  <li class="dropdown">
                        ...
                        <span class="fa fa-key"></span><span class="hidden-xs"> <?= $nm_user?></span></a>
